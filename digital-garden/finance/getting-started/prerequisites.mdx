...
description: Before you dive in, key points to assess
---
...
The information on this page is for educational purposes only and should not be considered as financial or investment advice.
The content reflects general principles and guidelines, which may not be suitable for every individual's financial situation.
Readers are strongly encouraged to conduct their own research, and the author assumes no responsibility for actions taken based on the information provided.
...
To know where to keep your cash, check information related to [Livret A](./account-types#livret-a), [LDDS](./account-types#ldds) and [LEP](./account-types#lep).
