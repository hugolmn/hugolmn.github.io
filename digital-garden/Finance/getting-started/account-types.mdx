...
| Account        	| Recommended duration                                    	| Typical taxes                                                  	|
|----------------	|---------------------------------------------------------	|----------------------------------------------------------------	|
| CTO            	| Any                                                     	| 30% flat tax on realized capital gains and perceived dividends 	|
| PEA            	| > 5 years                                               	| 17.2% social taxes on profits                                  	|
| Life Insurance 	| > 8 years                                               	| 17.2% social taxes + 7.5% flat tax on profits                  	|
| PER            	| Until retirement or purchase of your primary residence  	| 30% flat tax on profits                                        	|
...
- Some ETFs that use synthetic replication are eligible for this account even if the index tracked is not based in the EU.
